...
| Command | WS2022 | Ver. 2.2.1 | [Cmd-Executor-Windows2022](https://github.com/exastro-playbook-collection/Cmd-Executor-Windows2022/releases/download/ver.2.1.0/ansible-role-template-os-rhel9-ce-exastro-2.2.1.kym) | 任意の設定コマンド実行、および任意パスにファイルのアップロードを行う | [Role Readme](https://github.com/exastro-playbook-collection/Cmd-Executor-Windows2022/blob/master/README.md) |
